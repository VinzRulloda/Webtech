...
function toggleDisableUser(id) {
    ...
    if (id !== undefined){
        ...
        .then((data) => {
            ...
            document.getElementById("disableuserid").value = data.id;
        });
    }

    var addUserForm = document.getElementById("toggleDisableForm");
    if (addUserForm.style.display === "none" || addUserForm.style.display === "") {
        addUserForm.style.display = "block";
    } else {
        addUserForm.style.display = "none";
...
function toggleChangePasswordForm(id) {
